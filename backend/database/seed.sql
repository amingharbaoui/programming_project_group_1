...
(3, 'Demo', 'Admin', 'admin@ehb.be', 'school_sso', 'ehb-medewerker-0003', NULL, 'administratie', 'actief', NULL, 0, NULL, NOW(), 'import', NOW(), NOW()),
(4, 'Demo', 'Mentor', 'mentor@bedrijf.be', 'local', NULL, 'dev-placeholder-not-real-auth', 'mentor', 'actief', NULL, 0, NULL, NULL, 'manueel', NOW(), NOW()),
(5, 'Demo', 'Docent', 'docent@ehb.be', 'school_sso', 'ehb-medewerker-0005', NULL, 'docent', 'actief', NULL, 0, NULL, NOW(), 'import', NOW(), NOW());
...
(3, 'P000003', 'administratie', 'Administratief medewerker', 'Stageadministratie'),
(5, 'P000005', 'docent', 'Stagebegeleider', 'Toegepaste Informatica');
...
VALUES
(4, 1, 'Lead Developer', '+3200000001', true, 'geactiveerd', NULL, NULL, NOW());
